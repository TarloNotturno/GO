...
func baseExercise(printResult bool) {
	...
	if !printResult {
		...
		MySQRT.MyRad2(100, 0.0001)
		MySQRT.MyRad2(2, 0.0001)
		MySQRT.MyRad2(25, 0.00001)
	} else {
	...
	board := [][]string{
		...
		{"■", "□", "□", "■", "□", "□"},
		{"■", "□", "□", "□", "□", "■"}}
	FlowPrint.FillTheBoard(2, 4, board, printResult)
	FlowPrint.FillTheBoard(1, 1, board, printResult)
	...
	board = [][]string{
		...
		{"■", "■", "□", "□", "□"},
		{"■", "■", "□", "□", "□"}}
	FlowPrint.FillTheBoard(4, 6, board, printResult)
}
